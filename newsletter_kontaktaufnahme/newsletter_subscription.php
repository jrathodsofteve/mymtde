   ...
   ?>
    <form method="post" class="row padded">
        ...
        <div class="row form-group info-row">
            <div class="medium-12 columns">
              Sie haben sich per Postkarte für unseren PraxisLetter angemeldet. Vielen Dank! Hiermit haben Sie die Möglichkeit weitere Newsletter der Medical Tribune zu abonnieren.
            </div>
        </div>
        <br>
